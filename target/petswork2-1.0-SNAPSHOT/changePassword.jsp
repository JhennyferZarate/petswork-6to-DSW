    ...
    <div class="container w-75 bg-primary mt-5 shadow" style="background-color: white; border-radius: 10px 10px 10px 10px;">
        <div class="row align-items-stretch">
            ...
            color: #000000;">
                ...
                <h2 class="titulo2 text-center py-5">Cuenta comprobada, ahora cambia tu contraseña...</h2>
                ...
                <form action="#" class="needs-validation" novalidate>
                    ...
                    <div class="d-grid">
                        <a class="btn titulo4" type="submit" href="login.jsp" role="button">Cambiar Contraseña</a>
                    </div>
