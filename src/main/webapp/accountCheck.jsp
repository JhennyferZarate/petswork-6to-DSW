        ...
        <div class="row align-items-stretch">
            ...
            <div class="col bg-white p-5"
                ...
                <form action="#" class="needs-validation" novalidate>
                    <div class="mb-4">
                        <p for="email" class="titulo text-center py-2">Ingresa <span style="font-weight: bold;">el correo electrónico</span> con el que te registraste..</p>
                    ...
                    <div class="d-grid">
                        <a class="btn titulo4" type="submit" href="changePassword.jsp" role="button">Verificar</a>
                    </div>
